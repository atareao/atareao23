...
/**
 * Removes the style variations of atareao23 child themes inherited by the parent theme.
 *
 ...
 */
function atareao23_remove_style_variations_from_child_themes( $response, $handler ) {
    ...
    /*
     * Prevents atareao23 child themes from being considered child themes in the
...
add_filter( 'rest_request_before_callbacks', 'atareao23_remove_style_variations_from_child_themes', 10, 2 );
