...
return array(
    'title'      => __( 'Footer with 3 columns', 'atareao23' ),
    ...
    <div class="wp-block-group">
        ...
        <h3 style="font-size:14px;"><strong>' . esc_html__( 'More info', 'atareao23' ) . '</strong></h3>
        <!-- /wp:heading -->
        ...
        <h3 style="text-transform:uppercase;font-size:14px"><strong>' . esc_html__( 'Search', 'atareao23' ) . '</strong></h3><!-- /wp:heading --><!-- wp:search {"label":"' . esc_html__( 'Search', 'atareao23' ) . '","showLabel":false,"buttonText":"' . esc_html__( 'Search', 'atareao23' ) . '","buttonPosition":"button-inside"} /--></div>
        <!-- /wp:column --></div>
        <!-- /wp:columns --></div>
        <!-- /wp:group -->
