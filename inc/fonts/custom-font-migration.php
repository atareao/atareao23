...
add_action( 'init', 'migrate_atareao23_custom_fonts', 99 );

function migrate_atareao23_custom_fonts() {
    // The data has already been transformed
    if ( get_theme_mod( 'atareao23_legacy_font_settings' ) ) {
        return;
    }
